...
def db_main(theater, date_range, deletion_report=True, watchlist_notifications=True):
...
def parse_args():
    ...
    cli_parser.add_argument("--theater", default="AMC Methuen")
    ...
    email_parser.add_argument("--theater", action="append", dest="theaters")
